...
<html lang="en">
  <head>
    ...
    <title>SecureTrade - Decentralized Application</title>
  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h2><b>Welcome to SecureTrade </h2>
            <h3> Fake Product Detection Using Blockchain Technology</b></h3>
            <p style="max-width: 80%;">
            <br>
            <b>SecureTrade is a decentralized end-to-end logistics application that utilizes blockchain technology to record the location of products at every freight hub. At the consumer's end, customers can effortlessly scan a product's QR code to access comprehensive information about its origin, enabling consumers to make informed purchases of genuine and high-quality products.</b>
